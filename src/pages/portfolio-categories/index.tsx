...
export default function PortfolioCategoriesList() {
  ...
  const key = useMemo(() => {
    ...
    return `/portfolio-categories?${params.toString()}`;
  }, [q, status, page, limit]);
    ...
    },
    {
      ...
      render: (value: string) => (
        <div className="flex items-center justify-end gap-2">
          <Link
            href={`/portfolio-categories/${value}`}
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader
        ...
        description="Manage portfolio project categories"
        action={{
          label: 'New Category',
          href: '/portfolio-categories/new',
        }}
      />
        ...
        <DataTable
          ...
          emptyMessage={
            <div className="flex flex-col items-center gap-3 py-12">
              ...
              <Link href="/portfolio-categories/new" className="btn btn-primary mt-2">
