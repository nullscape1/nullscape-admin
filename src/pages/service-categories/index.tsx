...
export default function ServiceCategoriesList() {
  ...
  const key = useMemo(() => {
    ...
    return `/service-categories?${params.toString()}`;
  }, [q, status, page, limit]);
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader
        ...
        description="Manage service categories for the custom software development section"
        action={{
          label: 'New Category',
        ...
        <DataTable
          ...
          emptyMessage={
            <div className="flex flex-col items-center gap-3 py-12">
              ...
              <Link href="/service-categories/new" className="btn btn-primary mt-2">
