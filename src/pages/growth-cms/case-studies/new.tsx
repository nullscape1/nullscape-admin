...
export default function NewCaseStudyCms() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      await api.post('/cms-v2/case-studies', {
        title,
        industry,
        summary,
        featuredImage,
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center gap-4">
        ...
        <PageHeader title="New case study" description="Matches the reference “case study” story format (domain, opportunity, solution, result)." />
      </div>
      ...
      <form onSubmit={handleSubmit} className="card card-padding space-y-6 max-w-3xl">
        ...
        <div className="form-group">
          ...
          <input id="clientDomain" className="input" value={clientDomain} onChange={(e) => setClientDomain(e.target.value)} placeholder="e.g. Ed-Tech (AI-Powered Learning)" />
        </div>
        <div className="form-group">
