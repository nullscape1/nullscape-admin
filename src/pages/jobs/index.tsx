...
import { BriefcaseBusiness, Edit } from 'lucide-react';
        ...
        <DataTable
          ...
          emptyMessage={
            <div className="flex flex-col items-center gap-3 py-12">
              <BriefcaseBusiness className="w-12 h-12 text-muted-foreground opacity-50" />
              <div>
                <p className="font-medium">No job postings found</p>
                <p className="text-sm text-muted-foreground">
                  Add job postings to attract talent
                </p>
              </div>
            </div>
          }
